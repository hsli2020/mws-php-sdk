...
class OrderItem extends Model
{
    public function __construct($data = null)
    {
        $this->_fields = array (
            ...
            'PointsGranted'              => array('FieldValue' => null, 'FieldType' => __NAMESPACE__.'\\PointsGrantedDetail'),
            'ItemPrice'                  => array('FieldValue' => null, 'FieldType' => __NAMESPACE__.'\\Money'),
            'ShippingPrice'              => array('FieldValue' => null, 'FieldType' => __NAMESPACE__.'\\Money'),
            'GiftWrapPrice'              => array('FieldValue' => null, 'FieldType' => __NAMESPACE__.'\\Money'),
            'ItemTax'                    => array('FieldValue' => null, 'FieldType' => __NAMESPACE__.'\\Money'),
            'ShippingTax'                => array('FieldValue' => null, 'FieldType' => __NAMESPACE__.'\\Money'),
            'GiftWrapTax'                => array('FieldValue' => null, 'FieldType' => __NAMESPACE__.'\\Money'),
            'ShippingDiscount'           => array('FieldValue' => null, 'FieldType' => __NAMESPACE__.'\\Money'),
            'PromotionDiscount'          => array('FieldValue' => null, 'FieldType' => __NAMESPACE__.'\\Money'),
            'PromotionIds'               => array('FieldValue' => array(), 'FieldType' => array('string'), 'ListMemberName' => 'PromotionId'),
            'CODFee'                     => array('FieldValue' => null, 'FieldType' => __NAMESPACE__.'\\Money'),
            'CODFeeDiscount'             => array('FieldValue' => null, 'FieldType' => __NAMESPACE__.'\\Money'),
            'GiftMessageText'            => array('FieldValue' => null, 'FieldType' => 'string'),
            'GiftWrapLevel'              => array('FieldValue' => null, 'FieldType' => 'string'),
            'InvoiceData'                => array('FieldValue' => null, 'FieldType' => __NAMESPACE__.'\\InvoiceData'),
            ...
            'BuyerCustomizedInfo'        => array('FieldValue' => null, 'FieldType' => __NAMESPACE__.'\\BuyerCustomizedInfoDetail'),
        );

 ...
 */
 ...
 class InboundShipmentPlanRequestItemList extends FBAInboundServiceMWS_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'member' => array('FieldValue' => array(), 'FieldType' => array('InboundShipmentPlanRequestItem')),
    );
